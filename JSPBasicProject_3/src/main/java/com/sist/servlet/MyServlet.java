 ...
 *                           | 이미지 / 애니메이션 => 2000년대 웹 => 전자상거래 
 *              => 웹 서비스 기능을 해주는 자바 클래스 
 *                 => 자바 안에 HTML 코드를 첨부 (JSP => HTML 안에 Java 첨부)
 *                    out.write("<html>") => <%
 *                                           %>
 *                                           <html> 
 *                 => 단점 
 ...
 *               ====
 *               | 오라클 => package => jakarata => tomcat 10ver 이상
...
public class MyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // 디폴트 => 메인화면 => 화면 UI
		// 2. 변환 => 브라우저에 알려주는 내용 (HTML,XML,JSON) => JSP (page 지시자)
